...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class ScreenSpaceReflection : MonoBehaviour
    {
        ...
        public void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            float pixelsPerMeterAtOneMeter = sWidth / (-2.0f * (float)(Math.Tan(_camera.fieldOfView / 180.0 * Math.PI * 0.5)));
			...
			Matrix4x4 cameraToWorldMatrix = _camera.worldToCameraMatrix.inverse;
			...
			float z_f = _camera.farClipPlane;
			float z_n = _camera.nearClipPlane;
